...
const DestinationCards = ({ setCurrentDestination }) => {
  ...
  const data = [
    {
      label: "Camps",
      value: "Camps",
      destinationData: campData,
    },
    {
      label: "Resorts",
      value: "Resorts",
      destinationData: resortData,
    },
  ];
                    ...
                    return (
                      <Link to="/card-details">
                        <Card
                          ...
                          onClick={() => {
                            setCurrentDestination(destinationObject);
                          }}
                        >
                          <CardHeader floated={true} color="blue-gray">
                            <img
                              src={destinationObject.set1Images[0]}
                          ...
                          <CardBody>
                            <div className="mb-3 flex items-center justify-between">
                              <Typography
                                variant="h5"
                                color="blue-gray"
                                className="font-bold font-poppins text-xl text-left"
                              >
                            ...
                            <div className="flex flex-row flex-around">
                              <div className="flex  w-1/2 flex-col justify-center items-start">
                                ...
                                >
                                  ₹{destinationObject.actualVegPrice}/-
                                </Typography>
                                <Typography
                                  color="black"
                                  className="text-4xl font-bold text-cyan-900"
                                >
                                  ₹{destinationObject.discountedVegPrice}/-
                                </Typography>
                              </div>
                              <div className="flex w-1/2 flex-col justify-center items-start">
                                <Typography
